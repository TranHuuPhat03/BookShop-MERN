      ...
      <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
        <nav className="flex flex-col mx-4 my-6 space-y-4">
          ...
          <Link to="/dashboard/add-new-book" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            <span className="sr-only">Thêm sách</span>
          ...
          <Link to="/dashboard/manage-books" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            <span className="sr-only">Quản lý sách</span>
          ...
          <Link to="/dashboard/manage-orders" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            <span className="sr-only">Quản lý đơn hàng</span>
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
              ...
              <span className="text-sm text-gray-600">Quản trị</span>
            </div>
            <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src="https://anhdep.edu.vn/upload/2025/02/avatar-sieu-nhan-gao-hong-01.webp" alt="user profile photo" className="h-full w-full object-cover"/>
            </span>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
      ...
      <main className="p-6 sm:p-10 space-y-6 ">
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
          <div className="mr-6">
            <h1 className="text-4xl font-semibold mb-2">Bảng điều khiển</h1>
            <h2 className="text-gray-600 ml-0.5">Quản lý cửa hàng sách</h2>
          </div>
          <div className="flex flex-col md:flex-row items-start justify-end -mb-3">
            ...
            <Link to="/dashboard/manage-users" className="inline-flex px-5 py-3 text-white bg-blue-600 hover:bg-blue-700 focus:bg-blue-700 rounded-md ml-6 mb-3">
              <FaUsers className="flex-shrink-0 h-6 w-6 text-white -ml-1 mr-2" />
              Quản lý người dùng
            </Link>
            <Link to="/dashboard/manage-orders" className="inline-flex px-5 py-3 text-white bg-green-600 hover:bg-green-700 focus:bg-green-700 rounded-md ml-6 mb-3">
              <FaShoppingBag className="flex-shrink-0 h-6 w-6 text-white -ml-1 mr-2" />
              Quản lý đơn hàng
            </Link>
          </div>
        </div>
